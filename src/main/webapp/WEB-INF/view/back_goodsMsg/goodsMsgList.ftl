...
<div class="contant_weizhi2">
  ...
  <div id="page">
    ...
    <thead>
      <tr>
      <th class="th_bg" style="width:350px;" >货物类型</th>
      <th class="th_bg" >货物名称</th>
      <th class="th_bg" >货物数量</th>
      <th class="th_bg" >数量单位</th>
      <th class="th_bg" >起始省份</th>
      <th class="th_bg" >起始城市</th>
      <th class="th_bg" >抵达省份</th>
      <th class="th_bg" >抵达城市</th>
...
<td width="804" height="29"> <p align="center">
  <a href="${rc.contextPath}/goodsBackDetail/${goodsMsg.id}">详细</a></td>
</tr>
</#list>
</#if>
