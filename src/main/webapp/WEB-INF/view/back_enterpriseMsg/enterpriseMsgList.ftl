...
<div class="contant_weizhi2">
  ...
  <div id="page">
    ...
    <thead>
      <tr>
      <th class="th_bg" style="width:350px;" >企业类型</th>
      <th class="th_bg" >企业名称</th>
      <th class="th_bg" >经营范围</th>
      <th class="th_bg" >所属区域</th>
      <th class="th_bg" >地址</th>
...
<#list enterpriseMsgList as enterpriseMsg>
 <tr>
    ...
    <td width="17%" align="center"height="27"><a href="${rc.contextPath}/enterpriseBackDetail/${enterpriseMsg.id}">详细</a>　</td>
  </tr>
