...
<script language="javascript">
  ...
  <div class="welcome">
		<div class="welcome-left offer-left">
			...
			<h4>${knowledge.reside}、${knowledge.issuedate}</h4>
			<p>${knowledge.content}
			</p>
		</div>
        </div>
<table width="786" align="center" cellpadding="0" cellspacing="0">
	<tr>
    <td width="786" height="30" colspan="9" align="center">
        <a href="/logistics-web/Cars/CarMessage.jsp?topage=">上一篇</a>
        <a href="/logistics-web/Cars/CarMessage.jsp?topage=">下一篇</a>
